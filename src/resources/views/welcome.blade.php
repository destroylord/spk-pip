...
@section('content')
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="javascript:void(0)">About</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <form action="#">
                                    <a href="form-pendaftaran-siswa" type="submit" class="btn btn-primary btn-sm radius">Pendaftaran</a>
                                </form>
                            </div> <!-- navbar collapse -->
                        </nav> <!-- navbar -->
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="hero-content-wrapper">
                            <h2 class="mb-25 wow fadeInDown" data-wow-delay=".2s">Skotga</h2>
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="hero-img">
                            <div class="d-inline-block hero-img-right">
                                <img src="front/assets/img/hero/hero-img.png" alt="" class="image wow fadeInRight" data-wow-delay=".5s">
                                <img src="front/assets/img/hero/dots.shape.svg" alt="" class="dot-shape">
                                <div class="video-btn">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="about-img-wrapper">
                                <div class="about-img position-relative d-inline-block wow fadeInLeft" data-wow-delay=".3s">
                                    <img src="front/assets/img/about/about-img.png" alt="">
        ...
        <section id="contact" class="contact-section cta-bg img-bg pt-110 pb-100" style="background-image: url('front/assets/img/bg/cta-bg.jpg');">
            <div class="container">
                <div class="row align-items-center">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-widget mb-60 wow fadeInLeft" data-wow-delay=".2s">
                            <a href="index.html" class="logo mb-30"><img src="front/assets/img/logo/logo.svg" alt="logo"></a>

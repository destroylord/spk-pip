        ...
        <ul class="menu">
            ...
            <li
                ...
                <a href="#" class='sidebar-link'>
                    ...
                    <span>General Kriteria</span>
                </a>
                
                <ul class="submenu ">
                    <li class="submenu-item  ">
                        <a href="{{ route('admin.criteria') }}" wire:navigate class="submenu-link">Kriteria</a>
                        
                    </li>
                    
                    <li class="submenu-item  ">
                        <a href="{{ route('admin.sub.criteria') }}" wire:navigate class="submenu-link">Sub-Kriteria</a>
            ...
            <li
                ...
                <a href="#" class='sidebar-link'>
                 ...
                 <ul class="submenu ">
                    ...
                    <li class="submenu-item  ">
                        <a href="#" wire:navigate class="submenu-link">Konfigurasi form</a>
